...
import { discoverTsconfigPaths } from "@/modules/ui/tsconfig/discover"
import {
  mergeReferencesIntoRoot,
  mergeWithFrameworkTemplate,
} from "@/modules/ui/tsconfig/merge"
import { readTsconfigFile } from "@/modules/ui/tsconfig/parse"
import { renderTsconfig } from "@/modules/ui/tsconfig/render"
import {
  canAddBaseUrl,
  getTypescriptMajorVersion,
} from "@/modules/ui/tsconfig/typescriptVersion"
import type {
  TsconfigPatchPlan,
  UISelectedFramework,
  UITsconfigSelection,
